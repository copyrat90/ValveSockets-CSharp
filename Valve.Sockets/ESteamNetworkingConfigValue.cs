...
{
    public enum ESteamNetworkingConfigValue : uint
    {
        k_ESteamNetworkingConfig_Invalid = 0,
        k_ESteamNetworkingConfigimeoutInitial = 24,
        k_ESteamNetworkingConfigimeoutConnected = 25,
        ...
        k_ESteamNetworkingConfig_FakePacketReorderime = 8,
        k_ESteamNetworkingConfig_FakePacketDup_Send = 26,
        k_ESteamNetworkingConfig_FakePacketDup_Recv = 27,
        k_ESteamNetworkingConfig_FakePacketDupimeMax = 28,
        ...
        k_ESteamNetworkingConfig_P2Pransport_ICE_Enable = 104,
        k_ESteamNetworkingConfig_P2Pransport_ICE_Penalty = 105,
        k_ESteamNetworkingConfig_P2Pransport_SDR_Penalty = 106,
        k_ESteamNetworkingConfig_P2PURN_ServerList = 107,
        k_ESteamNetworkingConfig_P2PURN_UserList = 108,
        k_ESteamNetworkingConfig_P2PURN_PassList = 109,
        k_ESteamNetworkingConfig_P2Pransport_ICE_Implementation = 110,
