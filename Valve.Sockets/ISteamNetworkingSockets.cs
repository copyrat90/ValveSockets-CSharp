...
{
    /// <summary>Lower level networking API.</summary>
    /// <remarks>
    /// <para>- Connection-oriented API (like TCP, not UDP).  When sending and receiving</para>
    /// <para>messages, a connection handle is used.  (For a UDP-style interface, where</para>
    /// <para>the peer is identified by their address with each send/recv call, see</para>
    /// <para>ISteamNetworkingMessages.)  The typical pattern is for a "server" to "listen"</para>
    /// <para>on a "listen socket."  A "client" will "connect" to the server, and the</para>
    /// <para>server will "accept" the connection.  If you have a symmetric situation</para>
    /// <para>where either peer may initiate the connection and server/client roles are</para>
    /// <para>not clearly defined, check out k_ESteamNetworkingConfig_SymmetricConnect.</para>
    /// <para>- But unlike TCP, it's message-oriented, not stream-oriented.</para>
    /// <para>- Mix of reliable and unreliable messages</para>
    /// <para>- Fragmentation and reassembly</para>
    /// <para>- Supports connectivity over plain UDP</para>
    /// <para>- Also supports SDR ("Steam Datagram Relay") connections, which are</para>
    /// <para>addressed by the identity of the peer.  There is a "P2P" use case and</para>
    /// <para>a "hosted dedicated server" use case.</para>
    /// <para>Note that neither of the terms "connection" nor "socket" necessarily correspond</para>
    /// <para>one-to-one with an underlying UDP socket.  An attempt has been made to</para>
    /// <para>keep the semantics as similar to the standard socket model when appropriate,</para>
    /// <para>but some deviations do exist.</para>
    /// <para>See also: ISteamNetworkingMessages, the UDP-style interface.  This API might be</para>
    /// <para>easier to use, especially when porting existing UDP code.</para>
    /// </remarks>
    public partial interface ISteamNetworkingSockets : IDisposable
    {
        /// <summary>
        ...
        /// </remarks>
        uint CreateListenSocketIP(in global::Valve.Sockets.SteamNetworkingIPAddr localAddress, int nOptions, ReadOnlySpan<global::Valve.Sockets.SteamNetworkingConfigValue> pOptions);
        ...
        /// <para>setting the options "immediately" after creation.</para>
        /// </remarks>
        uint ConnectByIPAddress(in global::Valve.Sockets.SteamNetworkingIPAddr address, int nOptions, ReadOnlySpan<global::Valve.Sockets.SteamNetworkingConfigValue> pOptions);
        ...
        /// <para>setting the options "immediately" after creation.</para>
        /// </remarks>
        uint CreateListenSocketP2P(int nLocalVirtualPort, int nOptions, ReadOnlySpan<global::Valve.Sockets.SteamNetworkingConfigValue> pOptions);
        ...
        /// </remarks>
        uint ConnectP2P(in global::Valve.Sockets.SteamNetworkingIdentity identityRemote, int nRemoteVirtualPort, int nOptions, ReadOnlySpan<global::Valve.Sockets.SteamNetworkingConfigValue> pOptions);
        ...
        /// </remarks>
        global::Valve.Sockets.EResult AcceptConnection(uint hConn);
        ...
        /// <para>ignored.</para>
        /// </remarks>
        bool CloseConnection(uint hPeer, int nReason, string pszDebug, bool bEnableLinger);
        ...
        /// <summary>Set a name for the connection, used mostly for debugging</summary>
        void SetConnectionName(uint hPeer, string pszName);

        /// <summary>Fetch connection name.  Returns false if handle is invalid</summary>
        bool GetConnectionName(uint hPeer, string pszName, int nMaxLen);

        /// <summary>Send a message to the remote host on the specified connection.</summary>
        /// <remarks>
        ...
        /// </remarks>
        global::Valve.Sockets.EResult FlushMessagesOnConnection(uint hConn);
        ...
        /// </remarks>
        int ReceiveMessagesOnConnection(uint hConn, Span<IntPtr> ppOutMessages, int nMaxMessages);
        ...
        /// </remarks>
        global::Valve.Sockets.EResult GetConnectionRealTimeStatus(uint hConn, global::Valve.Sockets.SteamNetConnectionRealTimeStatus pStatus, int nLanes, Span<global::Valve.Sockets.SteamNetConnectionRealTimeLaneStatus> pLanes);
        ...
        /// </remarks>
        int GetDetailedConnectionStatus(uint hConn, string pszBuf, int cbBuf);

        /// <summary>Returns local IP and port that a listen socket created using CreateListenSocketIP is bound to.</summary>
        /// <remarks>
        /// <para>An IPv6 address of ::0 means "any IPv4 or IPv6"</para>
        /// <para>An IPv6 address of ::ffff:0000:0000 means "any IPv4"</para>
        /// </remarks>
        bool GetListenSocketAddress(uint hSocket, global::Valve.Sockets.SteamNetworkingIPAddr address);
        ...
        /// </summary>
        bool GetIdentity(global::Valve.Sockets.SteamNetworkingIdentity pIdentity);
        ...
        /// </remarks>
        global::Valve.Sockets.ESteamNetworkingAvailability InitAuthentication();
        ...
        /// <summary>Destroy a poll group created with CreatePollGroup().</summary>
        /// <remarks>
        ...
        /// </remarks>
        int ReceiveMessagesOnPollGroup(uint hPollGroup, Span<IntPtr> ppOutMessages, int nMaxMessages);
        ...
        /// <para>setting the options "immediately" after creation.</para>
        /// </remarks>
        uint ConnectToHostedDedicatedServer(in global::Valve.Sockets.SteamNetworkingIdentity identityTarget, int nRemoteVirtualPort, int nOptions, ReadOnlySpan<global::Valve.Sockets.SteamNetworkingConfigValue> pOptions);
        ...
        /// <para>setting the options "immediately" after creation.</para>
        /// </remarks>
        uint CreateHostedDedicatedServerListenSocket(int nLocalVirtualPort, int nOptions, ReadOnlySpan<global::Valve.Sockets.SteamNetworkingConfigValue> pOptions);
        ...
        /// </remarks>
        global::Valve.Sockets.EResult GetGameCoordinatorServerLogin(global::Valve.Sockets.SteamDatagramGameCoordinatorServerLogin pLoginInfo, ref int pcbSignedBlob, Span<byte> pBlob);
        ...
        /// <para>setting the options "immediately" after creation.</para>
        /// </remarks>
        uint ConnectP2PCustomSignaling(global::Valve.Sockets.ISteamNetworkingConnectionSignaling pSignaling, global::Valve.Sockets.SteamNetworkingIdentity pPeerIdentity, int nRemoteVirtualPort, int nOptions, ReadOnlySpan<global::Valve.Sockets.SteamNetworkingConfigValue> pOptions);
        ...
        /// </remarks>
        bool ReceivedP2PCustomSignal(ReadOnlySpan<byte> pMsg, int cbMsg, global::Valve.Sockets.ISteamNetworkingSignalingRecvContext pContext);
        ...
        bool GetCertificateRequest(ref int pcbBlob, Span<byte> pBlob, ref SteamNetworkingErrMsg errMsg);

        /// <summary>
        /// <para>Set the certificate.  The certificate blob should be the output of</para>
        /// <para>SteamDatagram_CreateCert.</para>
        /// </summary>
        bool SetCertificate(ReadOnlySpan<byte> pCertificate, int cbCertificate, ref SteamNetworkingErrMsg errMsg);
        ...
        /// </remarks>
        void ResetIdentity(global::Valve.Sockets.SteamNetworkingIdentity pIdentity);
        ...
        /// </remarks>
        uint CreateListenSocketP2PFakeIP(int idxFakePort, int nOptions, ReadOnlySpan<global::Valve.Sockets.SteamNetworkingConfigValue> pOptions);
        ...
        /// </remarks>
        global::Valve.Sockets.ISteamNetworkingFakeUDPPort CreateFakeUDPPort(int idxFakeServerPort);
        ...
        /// <para>for more information on how to configure dev environments.</para>
        /// </remarks>
        ushort HostedDedicatedServerPort { get; }

        /// <summary>
        /// <para>Returns 0 if SDR_LISTEN_PORT is not set.  Otherwise, returns the data center the server</para>
        /// <para>is running in.  This will be k_SteamDatagramPOPID_dev in non-production environment.</para>
        /// </summary>
        uint HostedDedicatedServerPOPID { get; }
    }
}